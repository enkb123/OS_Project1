...
class Process{
public:
    int ID; //stores the ID of process
    unsigned long long serviceTime; //stores the service time of process
    unsigned long long arrivalTime; //stores the arrival time of process
    int memory; //stores memory
    unsigned long long waitTime; //stores random wait time of process
...
int main(){
    ...
    /* used to calculate system tt and wt
    ...
    switch(scenario){
        case 1:
            ...
            switch(sortAl){
                ...
                case 2:{ //SJF scenario 1
                    priority_queue<unsigned long long> pqSJF1;
                    for(int n = 0; n<50; n++){
                        pqSJF1.push(-(pro[n].serviceTime));
                    }
                    while(!pqSJF1.empty()){ //while there are still processes
                        unsigned long long temp = pqSJF1.top();
                        pqSJF1.pop();
                        //finds the process connected to the service time
                        int i = 0;
                        while (pro[i].serviceTime != -(temp)){
                            i++;
                        }
                        //determines which processor to put process on
                        if(totTime1<=totTime2 && totTime1<=totTime3 && totTime1<=totTime4){
                            q1.push(pro[i]);
                ...
                case 3:{//SRT scenario 1
                    priority_queue<unsigned long long> pqSJF1;
                    for(int n = 0; n<50; n++){ //places the service times into a priority queue
                        pqSJF1.push(-(pro[n].serviceTime));
                    }
                    while(!pqSJF1.empty()){
                        unsigned long long temp = pqSJF1.top();
                        pqSJF1.pop();
                        //finds the process connected to the popped service time
                        int i = 0;
                        while (pro[i].serviceTime != -(temp)){
                            i++;
                        }
                        //determines which process to place the processor
                        if(totTime1<=totTime2 && totTime1<=totTime3 && totTime1<=totTime4){
                            q1.push(pro[i]);
                            cout<<"Process number:" << pro[i].ID<<endl;
                            cout<<"Service time:"<<pro[i].serviceTime<<endl<<"Arrival time:"<<0<<endl;
                    ...
                    //Determines system turnaround time
                    unsigned long long overallTime = totTime1;
                    if(totTime2>overallTime){
                        overallTime = totTime2;
                    }
                ...
                case 4:{ //RR Scenario 1

                    break;
                }
                case 5:{ //ML Scenario 1
                    priority_queue<int> pqML;
                    //places processes into priority queue based on priority
                    for(int n = 0; n<50; n++){
                    ...
                    while(!pqML.empty()){
                        int temp = pqML.top();
                        pqML.pop();
                        //finds process connected to priority
                        int i = 0;
                        while (pro[i].priority != temp || pro[i].done == true){
                            i++;
                        }
                        pro[i].done = true; //sets process to done
                        //determines which processor to put process on
                        if(totTime1<=totTime2 && totTime1<=totTime3 && totTime1<=totTime4){
                            q1.push(pro[i]);
                            cout<<"Process number:" << pro[i].ID<<endl<<"Service time:"<<pro[i].serviceTime<<endl<<"Arrival time:"<<0<<endl;
                    ...
                    //finds the system turnaround time
                    unsigned long long overallTime = totTime1;
                    if(totTime2>overallTime){
                        overallTime = totTime2;
                    }
        ...
        case 2:
            ...
            case 3: //SRT sceanrio 2
                {

                priority_queue<unsigned long long> pqSJF1;
                    //places processes into pqueue based on remaining time
                    for(int n = 0; n<50; n++){
                        pqSJF1.push(-(pro[n].serviceTime));
                    }
                    while(!pqSJF1.empty()){
                        unsigned long long temp = pqSJF1.top();
                        pqSJF1.pop();
                        //finds process connected to popped process
                        int i = 0;
                        while (pro[i].serviceTime != -(temp)){
                            i++;
                        }
            ...
            case 4://RR scenario 2
                break;
            case 5:{ //ML scenario 2
                    priority_queue<int> pqML;
                    //places processes into pqueue based on priority
                    for(int n = 0; n<50; n++){
                      pqML.push(pro[n].priority);
                    }
                    while(!pqML.empty()){
        ...
        case 3://scenario 3
            ...
            queue<Process> q4;
            switch(sortAl){
                case 1:{ //FIFO scenario 3
                    for(int i = 0; i<50; i++){
                        //calculates the number of cycles on the processor in relation to the speed of the processor
                ...
                case 2:{ //SJF scenario 3
                    priority_queue<unsigned long long> pqSJF1;
                    //places processes into pqueue based on service time
                    for(int n = 0; n<50; n++){
                        pqSJF1.push(-(pro[n].serviceTime));
                    }
                    while(!pqSJF1.empty()){
                    //calculates the number of cycles on the processor in relation to the speed of the processor
                        ...
                        unsigned long long temp = pqSJF1.top();
                        pqSJF1.pop();
                        //finds process connected to service time
                        int i = 0;
                        while (pro[i].serviceTime != -(temp)){
                            i++;
                        }
                        //determines which process to put processor on based on speed and number of cycles
                        if(avg1 <= avg2 && avg1 <= avg3 && avg1<= avg4){
                            q1.push(pro[i]);
                            cout<<"Process number:" << pro[i].ID<<endl<<"Service time:"<<pro[i].serviceTime<<endl<<"Arrival time:"<<0<<endl;
                            cout<<"Memory requirements:"<< pro[i].memory<<endl<<"Wait time:"<<totTime1<<endl<<"Total time in system:"<<totTime1+pro[i].serviceTime<<endl;
                ...
                case 3:{//SJF scenario 3
                    priority_queue<unsigned long long> pqSJF1;
                    //puts processes in pqueue based on service time
                    for(int n = 0; n<50; n++){
                        pqSJF1.push(-(pro[n].serviceTime));
                    }
                    while(!pqSJF1.empty()){
                    //calculates the number of cycles on the processor in relation to the speed of the processor
                        ...
                        unsigned long long temp = pqSJF1.top();
                        pqSJF1.pop();
                        //finds process that goes with popped service time
                        int i = 0;
                        while (pro[i].serviceTime != -(temp)){
                            i++;
                        }
                    ...
                    //determines the system turnaround time based on cycles
                    unsigned long long overallTime = totTime1;
                    if(totTime2>overallTime){
                        overallTime = totTime2;
                    }
                ...
                case 4: //RR scenario 3
                    break;
                case 5:{ //ML scenario 3
                    priority_queue<int> pqML;
                    //puts processes into pqueue based on priority
                    for(int n = 0; n<50; n++){
                      pqML.push(pro[n].priority);
                    }
                    while(!pqML.empty()){
        ...
        case 4:
            ...
            queue<Process> q4;
            switch(sortAl){
                case 1:{ //FIFO scenario 4
                    priority_queue<unsigned long long> pQ;
                    //places processes in pqueue based on arrival times
                    for(int n = 0; n<50; n++){
                    ...
                    while(!pQ.empty()){
                        ...
                        pQ.pop();
                        int i = 0;
                        //finds processes connected to arrival time
                        while (-(pro[i].arrivalTime) != temp){
                            i++;
                        }
                        if(totTime1<=totTime2 && totTime1<=totTime3 && totTime1<=totTime4){
                            q1.push(pro[i]);
                            if(totTime1 == 0){ //places first process on processor
                            ...
                            q2.push(pro[i]);
                            if(totTime2 == 0){//places first process on processor
                            ...
                            q3.push(pro[i]);
                            if(totTime3 == 0){//places first process on processor
                            ...
                            q4.push(pro[i]);
                            if(totTime4 == 0){//places first process on processor
                    ...
                    //calculates system turnaround time
                    unsigned long long overallTime = totTime1;
                    if(totTime2>overallTime){
                        overallTime = totTime2;
                    }
                ...
                case 2:{ //SJF scenario 4
                    ...
                    while(!arrivalPQ.empty()){
                        int i = 0;
                        if(totTime1 == 0 || totTime2 == 0 || totTime3 == 0 || totTime4 ==0){ //places first 4 processes
                        ...
                        //finds processor with least cycles
                    ...
                    //finds total system turnaround time
                    unsigned long long overallTime = totTime1;
                    if(totTime2>overallTime){
                        overallTime = totTime2;
                    }
                ...
                case 4:{ //RR scenario 4
                    break;
                }
                case 5://ML scenario 4
                    break;
                break;
                }
    }
